  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ta3LimApp.message.home.createOrEditLabel" data-cy="MessageCreateUpdateHeading">
            <Translate contentKey="ta3LimApp.message.home.createOrEditLabel">Create or edit a Message</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ta3LimApp.message.creationDate')}
              ...
              />
              <ValidatedField
                label={translate('ta3LimApp.message.messageText')}
              ...
              />
              <ValidatedField
                label={translate('ta3LimApp.message.isDelivered')}
                id="message-isDelivered"
                name="isDelivered"
                data-cy="isDelivered"
                check
                type="checkbox"
              ...
              <ValidatedField
                ...
                name="receiver"
                data-cy="receiver"
                label={translate('ta3LimApp.message.receiver')}
                type="select"
              >
                <option value="" key="0" />
                {users
              ...
              <ValidatedField
                ...
                name="sender"
                data-cy="sender"
                label={translate('ta3LimApp.message.sender')}
                type="select"
              >
                <option value="" key="0" />
                {users
