...
export const FileUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...fileEntity,
          resource: fileEntity?.resource?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ta3LimApp.file.home.createOrEditLabel" data-cy="FileCreateUpdateHeading">
            <Translate contentKey="ta3LimApp.file.home.createOrEditLabel">Create or edit a File</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ta3LimApp.file.label')}
                id="file-label"
                name="label"
                data-cy="label"
                type="text"
              ...
              />
              <ValidatedBlobField
                label={translate('ta3LimApp.file.file')}
                id="file-file"
                name="file"
                data-cy="file"
              ...
              <ValidatedField
                ...
                name="resource"
                data-cy="resource"
                label={translate('ta3LimApp.file.resource')}
                type="select"
              >
                <option value="" key="0" />
                {resources
