...
export const SkillDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const handleClose = () => {
    props.history.push('/skill' + props.location.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ta3LimApp.skill.delete.question">
        <Translate contentKey="ta3LimApp.skill.delete.question" interpolate={{ id: skillEntity.id }}>
