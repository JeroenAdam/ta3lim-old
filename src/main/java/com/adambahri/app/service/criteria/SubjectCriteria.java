...
/**
 * Criteria class for the {@link com.adambahri.app.domain.Subject} entity. This class is used
 * in {@link com.adambahri.app.web.rest.SubjectResource} to receive all the possible filtering options from
...
public class SubjectCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, label, creationDate, distinct);
    }
