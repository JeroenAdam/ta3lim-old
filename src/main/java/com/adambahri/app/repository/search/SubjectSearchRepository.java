...
class SubjectSearchRepositoryInternalImpl implements SubjectSearchRepositoryInternal {
    ...
    SubjectSearchRepositoryInternalImpl(ElasticsearchRestTemplate elasticsearchTemplate) {
    ...
    public Page<Subject> search(String query, Pageable pageable) {
        ...
        List<Subject> hits = elasticsearchTemplate
            .search(nativeSearchQuery, Subject.class)
