...
import com.adambahri.app.service.VotesQueryService;
...
/**
 * REST controller for managing {@link com.adambahri.app.domain.Votes}.
 */
@RestController
@RequestMapping("/api")
public class VotesResource {
     ...
     */
    @GetMapping("/votes")
    public ResponseEntity<List<VotesDTO>> getAllVotes(VotesCriteria criteria, Pageable pageable) {
    ...
    public ResponseEntity<List<VotesDTO>> searchVotes(@RequestParam String query, Pageable pageable) {
