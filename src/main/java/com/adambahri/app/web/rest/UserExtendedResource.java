...
import com.adambahri.app.service.UserExtendedQueryService;
...
import com.adambahri.app.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.adambahri.app.domain.UserExtended}.
 */
@RestController
@RequestMapping("/api")
public class UserExtendedResource {
    ...
    public ResponseEntity<List<UserExtendedDTO>> getAllUserExtendeds(UserExtendedCriteria criteria, Pageable pageable) {
        log.debug("REST request to get UserExtendeds by criteria: {}", criteria);
    ...
    public ResponseEntity<Long> countUserExtendeds(UserExtendedCriteria criteria) {
        log.debug("REST request to count UserExtendeds by criteria: {}", criteria);
    ...
    public ResponseEntity<List<UserExtendedDTO>> searchUserExtendeds(@RequestParam String query, Pageable pageable) {
