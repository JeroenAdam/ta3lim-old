...
import com.adambahri.app.domain.enumeration.NotificationType;
import com.adambahri.app.repository.NotificationRepository;
import com.adambahri.app.repository.search.NotificationSearchRepository;
import com.adambahri.app.service.criteria.NotificationCriteria;
import com.adambahri.app.service.dto.NotificationDTO;
import com.adambahri.app.service.mapper.NotificationMapper;
...
class NotificationResourceIT {
     ...
     *
     * @see com.adambahri.app.repository.search.NotificationSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllNotificationsByIsDeletedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        notificationRepository.saveAndFlush(notification);

        // Get all the notificationList where isDeleted not equals to DEFAULT_IS_DELETED
        defaultNotificationShouldNotBeFound("isDeleted.notEquals=" + DEFAULT_IS_DELETED);

        // Get all the notificationList where isDeleted not equals to UPDATED_IS_DELETED
        defaultNotificationShouldBeFound("isDeleted.notEquals=" + UPDATED_IS_DELETED);
    }
