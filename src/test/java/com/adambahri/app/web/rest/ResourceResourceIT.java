...
import com.adambahri.app.repository.search.ResourceSearchRepository;
import com.adambahri.app.service.ResourceService;
import com.adambahri.app.service.criteria.ResourceCriteria;
import com.adambahri.app.service.dto.ResourceDTO;
import com.adambahri.app.service.mapper.ResourceMapper;
...
class ResourceResourceIT {
     ...
     *
     * @see com.adambahri.app.repository.search.ResourceSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllResourcesByTitleIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where title not equals to DEFAULT_TITLE
        defaultResourceShouldNotBeFound("title.notEquals=" + DEFAULT_TITLE);

        // Get all the resourceList where title not equals to UPDATED_TITLE
        defaultResourceShouldBeFound("title.notEquals=" + UPDATED_TITLE);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultResourceShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the resourceList where creationDate not equals to UPDATED_CREATION_DATE
        defaultResourceShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByDescriptionIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where description not equals to DEFAULT_DESCRIPTION
        defaultResourceShouldNotBeFound("description.notEquals=" + DEFAULT_DESCRIPTION);

        // Get all the resourceList where description not equals to UPDATED_DESCRIPTION
        defaultResourceShouldBeFound("description.notEquals=" + UPDATED_DESCRIPTION);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByAngeRageIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where angeRage not equals to DEFAULT_ANGE_RAGE
        defaultResourceShouldNotBeFound("angeRage.notEquals=" + DEFAULT_ANGE_RAGE);

        // Get all the resourceList where angeRage not equals to UPDATED_ANGE_RAGE
        defaultResourceShouldBeFound("angeRage.notEquals=" + UPDATED_ANGE_RAGE);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByUrlIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);
    ...
    @Test
    @Transactional
    void getAllResourcesByAuthorIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where author not equals to DEFAULT_AUTHOR
        defaultResourceShouldNotBeFound("author.notEquals=" + DEFAULT_AUTHOR);

        // Get all the resourceList where author not equals to UPDATED_AUTHOR
        defaultResourceShouldBeFound("author.notEquals=" + UPDATED_AUTHOR);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByLastUpdatedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where lastUpdated not equals to DEFAULT_LAST_UPDATED
        defaultResourceShouldNotBeFound("lastUpdated.notEquals=" + DEFAULT_LAST_UPDATED);

        // Get all the resourceList where lastUpdated not equals to UPDATED_LAST_UPDATED
        defaultResourceShouldBeFound("lastUpdated.notEquals=" + UPDATED_LAST_UPDATED);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByActivatedIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where activated not equals to DEFAULT_ACTIVATED
        defaultResourceShouldNotBeFound("activated.notEquals=" + DEFAULT_ACTIVATED);

        // Get all the resourceList where activated not equals to UPDATED_ACTIVATED
        defaultResourceShouldBeFound("activated.notEquals=" + UPDATED_ACTIVATED);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByViewsIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where views not equals to DEFAULT_VIEWS
        defaultResourceShouldNotBeFound("views.notEquals=" + DEFAULT_VIEWS);

        // Get all the resourceList where views not equals to UPDATED_VIEWS
        defaultResourceShouldBeFound("views.notEquals=" + UPDATED_VIEWS);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByVotesIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where votes not equals to DEFAULT_VOTES
        defaultResourceShouldNotBeFound("votes.notEquals=" + DEFAULT_VOTES);

        // Get all the resourceList where votes not equals to UPDATED_VOTES
        defaultResourceShouldBeFound("votes.notEquals=" + UPDATED_VOTES);
    }
    ...
    @Test
    @Transactional
    void getAllResourcesByApprovedByIsNotEqualToSomething() throws Exception {
        // Initialize the database
        resourceRepository.saveAndFlush(resource);

        // Get all the resourceList where approvedBy not equals to DEFAULT_APPROVED_BY
        defaultResourceShouldNotBeFound("approvedBy.notEquals=" + DEFAULT_APPROVED_BY);

        // Get all the resourceList where approvedBy not equals to UPDATED_APPROVED_BY
        defaultResourceShouldBeFound("approvedBy.notEquals=" + UPDATED_APPROVED_BY);
    }
    ...
    void putNewResource() throws Exception {
        ...
        // Validate the Resource in Elasticsearch
        verify(mockResourceSearchRepository).save(testResource);
    }
    ...
    void searchResource() throws Exception {
        ...
        // Initialize the database
        resourceRepository.saveAndFlush(resource);
        when(mockResourceSearchRepository.search("id:" + resource.getId(), PageRequest.of(0, 20)))
