...
import com.adambahri.app.repository.search.SubjectSearchRepository;
import com.adambahri.app.service.criteria.SubjectCriteria;
import com.adambahri.app.service.dto.SubjectDTO;
import com.adambahri.app.service.mapper.SubjectMapper;
...
class SubjectResourceIT {
     ...
     *
     * @see com.adambahri.app.repository.search.SubjectSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllSubjectsByLabelIsNotEqualToSomething() throws Exception {
        // Initialize the database
        subjectRepository.saveAndFlush(subject);

        // Get all the subjectList where label not equals to DEFAULT_LABEL
        defaultSubjectShouldNotBeFound("label.notEquals=" + DEFAULT_LABEL);

        // Get all the subjectList where label not equals to UPDATED_LABEL
        defaultSubjectShouldBeFound("label.notEquals=" + UPDATED_LABEL);
    }
    ...
    @Test
    @Transactional
    void getAllSubjectsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        subjectRepository.saveAndFlush(subject);

        // Get all the subjectList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultSubjectShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the subjectList where creationDate not equals to UPDATED_CREATION_DATE
        defaultSubjectShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
    ...
    void putNewSubject() throws Exception {
        ...
        // Validate the Subject in Elasticsearch
        verify(mockSubjectSearchRepository).save(testSubject);
    }
    ...
    void searchSubject() throws Exception {
        ...
        // Initialize the database
        subjectRepository.saveAndFlush(subject);
        when(mockSubjectSearchRepository.search("id:" + subject.getId(), PageRequest.of(0, 20)))
