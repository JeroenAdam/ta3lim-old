...
import com.adambahri.app.service.criteria.UserExtendedCriteria;
...
class UserExtendedResourceIT {
     ...
     *
     * @see com.adambahri.app.repository.search.UserExtendedSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByLastLoginIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where lastLogin not equals to DEFAULT_LAST_LOGIN
        defaultUserExtendedShouldNotBeFound("lastLogin.notEquals=" + DEFAULT_LAST_LOGIN);

        // Get all the userExtendedList where lastLogin not equals to UPDATED_LAST_LOGIN
        defaultUserExtendedShouldBeFound("lastLogin.notEquals=" + UPDATED_LAST_LOGIN);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByAboutMeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where aboutMe not equals to DEFAULT_ABOUT_ME
        defaultUserExtendedShouldNotBeFound("aboutMe.notEquals=" + DEFAULT_ABOUT_ME);

        // Get all the userExtendedList where aboutMe not equals to UPDATED_ABOUT_ME
        defaultUserExtendedShouldBeFound("aboutMe.notEquals=" + UPDATED_ABOUT_ME);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByOccupationIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where occupation not equals to DEFAULT_OCCUPATION
        defaultUserExtendedShouldNotBeFound("occupation.notEquals=" + DEFAULT_OCCUPATION);

        // Get all the userExtendedList where occupation not equals to UPDATED_OCCUPATION
        defaultUserExtendedShouldBeFound("occupation.notEquals=" + UPDATED_OCCUPATION);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsBySocialMediaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where socialMedia not equals to DEFAULT_SOCIAL_MEDIA
        defaultUserExtendedShouldNotBeFound("socialMedia.notEquals=" + DEFAULT_SOCIAL_MEDIA);

        // Get all the userExtendedList where socialMedia not equals to UPDATED_SOCIAL_MEDIA
        defaultUserExtendedShouldBeFound("socialMedia.notEquals=" + UPDATED_SOCIAL_MEDIA);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByCivilStatusIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where civilStatus not equals to DEFAULT_CIVIL_STATUS
        defaultUserExtendedShouldNotBeFound("civilStatus.notEquals=" + DEFAULT_CIVIL_STATUS);

        // Get all the userExtendedList where civilStatus not equals to UPDATED_CIVIL_STATUS
        defaultUserExtendedShouldBeFound("civilStatus.notEquals=" + UPDATED_CIVIL_STATUS);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByFirstchildIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where firstchild not equals to DEFAULT_FIRSTCHILD
        defaultUserExtendedShouldNotBeFound("firstchild.notEquals=" + DEFAULT_FIRSTCHILD);

        // Get all the userExtendedList where firstchild not equals to UPDATED_FIRSTCHILD
        defaultUserExtendedShouldBeFound("firstchild.notEquals=" + UPDATED_FIRSTCHILD);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsBySecondchildIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where secondchild not equals to DEFAULT_SECONDCHILD
        defaultUserExtendedShouldNotBeFound("secondchild.notEquals=" + DEFAULT_SECONDCHILD);

        // Get all the userExtendedList where secondchild not equals to UPDATED_SECONDCHILD
        defaultUserExtendedShouldBeFound("secondchild.notEquals=" + UPDATED_SECONDCHILD);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByThirdchildIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where thirdchild not equals to DEFAULT_THIRDCHILD
        defaultUserExtendedShouldNotBeFound("thirdchild.notEquals=" + DEFAULT_THIRDCHILD);

        // Get all the userExtendedList where thirdchild not equals to UPDATED_THIRDCHILD
        defaultUserExtendedShouldBeFound("thirdchild.notEquals=" + UPDATED_THIRDCHILD);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByFourthchildIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where fourthchild not equals to DEFAULT_FOURTHCHILD
        defaultUserExtendedShouldNotBeFound("fourthchild.notEquals=" + DEFAULT_FOURTHCHILD);

        // Get all the userExtendedList where fourthchild not equals to UPDATED_FOURTHCHILD
        defaultUserExtendedShouldBeFound("fourthchild.notEquals=" + UPDATED_FOURTHCHILD);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByFilesquotaIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where filesquota not equals to DEFAULT_FILESQUOTA
        defaultUserExtendedShouldNotBeFound("filesquota.notEquals=" + DEFAULT_FILESQUOTA);

        // Get all the userExtendedList where filesquota not equals to UPDATED_FILESQUOTA
        defaultUserExtendedShouldBeFound("filesquota.notEquals=" + UPDATED_FILESQUOTA);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByApproverSinceIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where approverSince not equals to DEFAULT_APPROVER_SINCE
        defaultUserExtendedShouldNotBeFound("approverSince.notEquals=" + DEFAULT_APPROVER_SINCE);

        // Get all the userExtendedList where approverSince not equals to UPDATED_APPROVER_SINCE
        defaultUserExtendedShouldBeFound("approverSince.notEquals=" + UPDATED_APPROVER_SINCE);
    }
    ...
    @Test
    @Transactional
    void getAllUserExtendedsByLastApprovalIsNotEqualToSomething() throws Exception {
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);

        // Get all the userExtendedList where lastApproval not equals to DEFAULT_LAST_APPROVAL
        defaultUserExtendedShouldNotBeFound("lastApproval.notEquals=" + DEFAULT_LAST_APPROVAL);

        // Get all the userExtendedList where lastApproval not equals to UPDATED_LAST_APPROVAL
        defaultUserExtendedShouldBeFound("lastApproval.notEquals=" + UPDATED_LAST_APPROVAL);
    }
    ...
    void putNewUserExtended() throws Exception {
        ...
        // Validate the UserExtended in Elasticsearch
        verify(mockUserExtendedSearchRepository).save(testUserExtended);
    }
    ...
    void searchUserExtended() throws Exception {
        ...
        // Initialize the database
        userExtendedRepository.saveAndFlush(userExtended);
        when(mockUserExtendedSearchRepository.search("id:" + userExtended.getId(), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(userExtended), PageRequest.of(0, 1), 1));
