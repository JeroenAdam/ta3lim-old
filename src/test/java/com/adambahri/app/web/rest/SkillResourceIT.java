...
import com.adambahri.app.repository.SkillRepository;
import com.adambahri.app.repository.search.SkillSearchRepository;
import com.adambahri.app.service.criteria.SkillCriteria;
import com.adambahri.app.service.dto.SkillDTO;
import com.adambahri.app.service.mapper.SkillMapper;
...
class SkillResourceIT {
     ...
     *
     * @see com.adambahri.app.repository.search.SkillSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    @Test
    @Transactional
    void getAllSkillsByLabelIsNotEqualToSomething() throws Exception {
        // Initialize the database
        skillRepository.saveAndFlush(skill);

        // Get all the skillList where label not equals to DEFAULT_LABEL
        defaultSkillShouldNotBeFound("label.notEquals=" + DEFAULT_LABEL);

        // Get all the skillList where label not equals to UPDATED_LABEL
        defaultSkillShouldBeFound("label.notEquals=" + UPDATED_LABEL);
    }
    ...
    @Test
    @Transactional
    void getAllSkillsByCreationDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        skillRepository.saveAndFlush(skill);

        // Get all the skillList where creationDate not equals to DEFAULT_CREATION_DATE
        defaultSkillShouldNotBeFound("creationDate.notEquals=" + DEFAULT_CREATION_DATE);

        // Get all the skillList where creationDate not equals to UPDATED_CREATION_DATE
        defaultSkillShouldBeFound("creationDate.notEquals=" + UPDATED_CREATION_DATE);
    }
